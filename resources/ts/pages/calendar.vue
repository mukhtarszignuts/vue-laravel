...
import { blankEvent, useCalendar } from "./calendar/useCalendar";
import { useCalendarStore } from "./calendar/useCalendarStore";

// Components
import CalendarEventHandler from "@/pages/calendar/CalendarEventHandler.vue";
...
const checkAll = computed({
  ...
  */
  ...
  set: (val) => {
    if (val)
      store.selectedCalendars = store.availableCalendars.map((i) => i.id);
